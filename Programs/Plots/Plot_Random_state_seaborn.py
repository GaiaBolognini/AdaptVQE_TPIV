...
sns.lineplot(x="variable", y="value", data=df_65)
sns.lineplot(x="variable", y="value", data=df_40)
plt.legend(labels=['Dim = 65', 'Dim = 40'])
...
plt.axhline(y=ground_state, color='r', linestyle='-', label= 'Ground State Energy')
sns.lineplot(x="variable", y="value", data=df_65)
sns.lineplot(x="variable", y="value", data=df_30)
plt.legend(labels=['Dim = 65', 'Dim = 30'])
plt.xlabel("Iterations")
plt.ylabel("Energy, Ha")
...
plt.axhline(y=ground_state, color='r', linestyle='-', label= 'Ground State Energy')
sns.lineplot(x="variable", y="value", data=df_65)
sns.lineplot(x="variable", y="value", data=df_20)
plt.legend(labels=['Dim = 65', 'Dim = 20'])
plt.xlabel("Iterations")
plt.ylabel("Energy, Ha")
...
plt.axhline(y=ground_state, color='r', linestyle='-', label= 'Ground State Energy')
sns.lineplot(x="variable", y="value", data=df_65)
sns.lineplot(x="variable", y="value", data=df_15)
plt.legend(labels=['Dim = 65', 'Dim = 15'])
plt.xlabel("Iterations")
plt.ylabel("Energy, Ha")
