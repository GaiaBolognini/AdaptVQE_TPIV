#implementing Adapt-VQE algorithm to solve H2 molecule
...
dev_draw._circuit.draw(output='mpl',filename = '/mnt/c/Users/gaias/Desktop/Adapt_VQE_TPIV/Images/Circuit_H2_Adapt.pdf' )
